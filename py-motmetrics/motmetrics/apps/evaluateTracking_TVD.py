...
string in the seqmap.""", formatter_class=argparse.RawTextHelpFormatter)
    ...
    parser.add_argument('--groundtruths', type=str, default = '/data/Datasets/TVD/train', help='D:/TVD_object_tracking_dataset_and_annotations/TVD-01/gt')
    parser.add_argument('--tests', type=str, help='Directory containing tracker result files')
    parser.add_argument('--seqmap', type=str, default ='./seqmap_TVD.txt', help='Text file containing all sequences name')
